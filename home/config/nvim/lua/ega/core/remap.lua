...
vmap("n", "<M-h>", "<cmd>TmuxNavigateLeft<CR>", KeyOpts("Navigate Left"))
vmap("n", "<M-j>", "<cmd>TmuxNavigateDown<CR>", KeyOpts("Navigate Down"))
vmap("n", "<M-k>", "<cmd>TmuxNavigateUp<CR>", KeyOpts("Navigate Up"))
vmap("n", "<M-l>", "<cmd>TmuxNavigateRight<CR>", KeyOpts("Navigate Right"))
